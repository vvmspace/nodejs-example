...
const parse_xml = async () => {
    ...
    await eventSchema.update({alias: 'kino'}, {$set: {ssr: true,
            name: 'Кино (30 лет без Кино)',
            alias: 'kino',
            description:
...
<p>В этом году концерт состоится <strong>21 ноября 2020</strong> на площадке <strong>ВТБ Арена</strong> и обещает быть ещё более потрясающим.</p>
<p>Организаторы концерта поставили перед собой задачу проэкспериментировать и показать концепцию <strong>концерта группы Кино в 2020 году</strong>.</p>
