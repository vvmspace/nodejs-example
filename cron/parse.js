...
const parse_xml = async () => {
    ...
    //     }}));
    await eventSchema.update({alias: 'trubetskoy'}, {$set: {ssr: true, ref_code: 'concertmoscowc',
            description:
            `<p>Трубецкой — это наследники легендарного белорусского коллектива, прославившегося под названием "Ляпис Трубецкой". Они организовали собственную группу после распада предшественников, а именно в 2014 году, объединив сразу нескольких экс-исполнителей. Возглавил коллектив вокалист Павел Булатников. И сейчас каждый может посетить концерт Трубецкой в столице, который состоится 6 марта 2020. В его рамках Трубецкой исполнит композиции, записанные еще задолго до создания нового коллектива.</p>



<p>Это всеми любимые хиты, которые нашли отклик среди миллионов поклонников. <strong>Трубецкой в Москве</strong> порадует слушателей такими песнями, как: "Евпатория", "Яблони", "В платье белом", "Ты кинула", "Увезу тебя" и т.д. Каждый человек знает эти, и многие другие треки известной группы наизусть, и с удовольствием подпевает музыкантам. Но сейчас каждый имеет возможность насладиться легендарной музыкой в живом исполнении. Нужно лишь посетить <strong>концерт Трубецкой в Главклуб GREEN CONCERT</strong>. Поэтому не упустите этого шанса, и скорее приобретайте <strong>билеты на Трубецкой 6 марта 2020</strong>, т.к. их количество ограничено.</p>`}});
