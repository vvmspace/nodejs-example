...
const parse_xml = async () => {
    ...
    await eventSchema.update({alias: 'sting'}, {$set: {ssr: true, description:
            `<p>Всеми полюбившийся британский музыкант <b>Sting</b> снова возвращается в Москву! Выступление состоится на площади <b>дворца спорта "Мегаспорт" 29 сентября.</b></p>
<p>Фанатов музыканта снова ждет невероятное представление! STING порадует такими полюбившимися песнями как: Fields Of Gold, Shape Of My Heart, Roxanne. Более двадцати лет он остается одним из самых ярких музыкантов, композиторов и активистов.</p>
<p>Программа <b>Sting My Songs</b> - это динамическое и незабываемое шоу с участием полноформатного рок-коллектива.</p>
<p>Стинга можно назвать одним из самых успешных солистов в истории поп-музыки. Его по праву можно считать гением мягкой романтики и релакса. Главные хиты строятся на медитации и борьбе за экологию. Даже столь беспокойная композиция как «Mad About You» пронизана гармонией и внутренним спокойствием. Выступление <b>Sting в Москве</b> обещает стать одним из самых ярких событий осени 2020!</p>
<p>Его треки нельзя отнести к определенному стилю. Здесь можно встретить джаз, рок, поп и регги. Возможно, именно это и является изюминкой музыканта и заставляет миллионы слушателей с замиранием сердца слушать композиции.</p>
<p>Заказывайте билеты на нашем сайте прямо сейчас, ведь Sting - это легенда! Только один концерт Стинга в Москве! Не упусти свой шанс!</p>`}});
