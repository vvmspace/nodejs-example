...
const parse_xml = async () => {
    ...
    await eventSchema.update({alias: 'ddt'}, {$set: {ssr: true, description:
            `<p>Большой концерт группы «ДДТ» в Москве. Юбилейный тур.</p>
<p>В текущем году легендарная питерская "ДДТ" отмечает сорокалетний юбилей! Само собой, от мастодонтов русского рока трудно не ожидать масштабный и грандиозный тур по стране в честь такого события. <b>6 июня в Москве</b> состоится один из трех стадионных концертов тура (два других пройдут в Уфе и <b>Санкт-Петербурге</b>).</p>
<p>Трек-лист программы пока под секретом, однако, наверняка стоит ожидать легендарные хиты, проверенные временем и новинки группы.</p>
<p>&nbsp;</p>
<p>Трудно не согласиться с тем, что ДДТ - истинные легенды отечественной рок-сцены и знакомы они каждому. Образовавшись в Уфе в 1980-ом году, на протяжении сорока лет, коллектив пережил многое. Но как бы там ни было, Юрий Шевчук, являясь бессменым лидером группы, продолжает нести через своё творчество правду, лирику, переживания и размышления. Дополняется всё это потрясающей атмосферой на концертной площадке, спецэффектами и профессиональным подходом ко всем аспектам звука, света и шоу.</p>
<p>&nbsp;</p>
<p>Каждый, кто хоть раз слышал и проникся творчеством Юрия Шевчука и группы ДДТ - просто обязан побывать на концерте <b>юбилейного тура ДДТ: 40 лет русского рока</b>, что бы воочую оценить весь масштаб и зрелищность одной из величайших рок-групп России!</p>`}});
