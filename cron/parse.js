...
const parse_xml = async () => {
    ...
    await eventSchema.update({alias: 'trubetskoy'}, {$set: {ssr: true, ref_code: 'concertmoscowc',
            description:
            `<p><strong>Trubetskoy</strong> - наследники легендарного белорусского коллектива "Ляпис Трубецкого". Они решили основать собственную группу в 2014 году, а на <u>6 марта 2020 запланирован концерт Трубецкого в Москве</u>. На сцену выйдет вся команда, в том числе лидер и вокалист музыкального коллектива — <strong>Павел Булатников</strong>.</p>
<p>В рамках программы зрителям будет презентован <strong>новый альбом</strong>, полный зажигательных хитов сразу на нескольких языках. Но одновременно с этим со сцены прозвучат и уже всем полюбившиеся композиции. Исполнители выступают в жанре альтернативного, панк и поп-панк рока. Это будет действительно яркое и легендарное шоу, которое точно не оставит равнодушным даже далеких от данных направлений людей.</p>
<p>На концерте будет безумно драйвово и зажигательно, что придется по душе слушателям разного пола и возраста. Поэтому пришло самое время покупать <strong>билеты на Трубецкого в Главклуб GREEN CONCERT</strong>. Ведь до этого события остается меньше пяти дней!</p>`}});
