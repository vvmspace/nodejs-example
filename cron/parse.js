...
const parse_xml = async () => {
    ...
    let _event;
    await eventSchema.update({alias: 'uma2rmah'}, {$set: {ssr: true,
            alias: 'umaturman',
            title: 'Uma2rman [Уматурман]',
            description:
            `<blockquote>"Квентин, если ты не заметил, то я жду Володьку из Тагила, а тебя вообще заходить не просила."</blockquote>
<p>&nbsp;</p>
