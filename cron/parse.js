...
const parse_xml = async () => {
    ...
    //     }}));
    await eventSchema.update({alias: 'kuzmin-vladimir-november-21-2020'}, {$set: {ssr: true, ref_code: 'concertmoscowc',
            description:
            `<p>Легендарный отечественный рок-музыкант вновь собирает истинных любителей качественной музыки и бессмертных хитов – уже совсем скоро концерт Владимира Кузьмина в Москве! На этот раз спеть любимые хиты 80-х и 90-х, а также услышать авторское живое исполнение новых песен из последнего альбома «Плохая репутация» (2019 г.) можно будет в столичном Академ Джаз Клубе, 21 ноября 2020 года. Неповторимая камерная атмосфера, виртуозные гитарные соло, качественный звук, пронизывающие душу тексты и драйв не оставят вас равнодушными. На живом выступлении Владимира Кузьмина станете не просто сторонними наблюдателями творчества потрясающего артиста, но и сами станете участником действа, которое увлечет вас с первых аккордов. Спешите приобрести билеты по наиболее выгодной цене на самые лучшие места. В этот московский ноябрьский вечер в Академ Джаз Клубе будет жарко!</p>`}});
