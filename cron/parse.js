...
const parse_xml = async () => {
    ...
    let _event;
    await eventSchema.update({alias: 'uma2rman'}, {$set: {ssr: true,
            title: 'Uma2rman [Уматурман]',
            description:
            `<blockquote>"Квентин, если ты не заметил, то я жду Володьку из Тагиле, а тебя вообще заходить не просила."</blockquote>
<p>&nbsp;</p>
<p>Группа <b>Uma2rman</b> была создана в 2003 году <strong>братьями Кристовскими</strong>. Дебютировав на сцене в рамках концерта Земфиры 19 декабря 2003 года, братья начали свою бурную музыкальную, концертную деятельность. Песня «Прасковья» принесла группе большую популярность в 2004 году.</p>
            <p>Уже почти 17 лет группа радует своими песнями и хитами, такими как: «Прасковья», «Простится», «Письмо Уме», «Тенис», «<strong>Уматурман</strong>» и многие другие. Также группа записала саундтрек к уже культовому телесериалу «Папины дочки» с одноименным названием .В Москве состоится их сольный концерт на котором прозвучат хиты группы и также новые композиции, вы можете услышать их в живую, придя в <strong>главклуб 31 мая 2020 г.</strong>. </p>`}});
